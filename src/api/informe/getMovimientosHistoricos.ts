...
export async function getMovimientosHistoricos(fechaInicio?: string, fechaFin?: string) {
  try {
    let url = `${API_URL}/informes/movimientos-historicos`;
...
export function useGetMovimientosHistoricos(fechaInicio?: string, fechaFin?: string) {
  return useQuery({
    queryKey: ["informes", "movimientosHistoricos", fechaInicio, fechaFin],
