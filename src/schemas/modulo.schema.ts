...
export const moduloSchema = z.object({
  ...
  if (data.es_submenu === true && (data.modulo_padre_id === null || data.modulo_padre_id === undefined)) {
    ctx.addIssue({
      code: z.ZodIssueCode.custom,
      message: 'El módulo padre es obligatorio para los submódulos.',
      path: ['modulo_padre_id'],
    });
  }
});
